...
This GPT is built on **ChatGPT (OpenAI)**. Your conversation data within ChatGPT is subject to [OpenAI's Privacy Policy](https://openai.com/privacy).

The resume data is hosted on **GitHub Pages**. GitHub's data handling is subject to [GitHub's Privacy Policy](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement).

---

## 3. Data Sharing

No user data is collected, stored, or shared by this service.

---

## 4. Security

All API data is served over **HTTPS** via GitHub Pages. The data served is entirely public resume information voluntarily shared by Sarav Kumar.
